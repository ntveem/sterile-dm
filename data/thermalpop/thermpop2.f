...
C--- Muon Calculation
      ...
      open(unit=10,file='thermmu2.dat',status='new')
      do i=1,ntemp
         numdens = 0.d0
         ke      = 0.d0
...
C --- Tauon Calculation
      ...
      open(unit=10,file='thermtau2.dat',status='new')
...
C--- Charm Quark Calculation : min at 50 MeV
      ...
      open(unit=10,file='thermc2.dat',status='new')
      mass = massc
...
C---Bottom Quark Calculation - cut off at 50 MeV
      ...
      open(unit=10,file='thermb2.dat',status='new')
